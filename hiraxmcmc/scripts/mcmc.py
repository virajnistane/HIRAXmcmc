...
currentparams_fixed = params_fixed.current_params_to_vary_fixed(params_to_vary, inputforhiraxoutput, freqdep_paramstovary=freqdep_paramstovary)

# Initialization of currentparams
currentparams = params_fixed.current_params_to_vary_fixed(params_to_vary, inputforhiraxoutput, freqdep_paramstovary=freqdep_paramstovary)
