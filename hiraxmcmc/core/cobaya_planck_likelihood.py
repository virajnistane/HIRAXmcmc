...
pf = ParametersFixed()
curpartemp = {'h': 0.68, 'Omk': -0.01, 'Oml': 0.70, 'w0': -1, 'wa': 0}
OmM = 1 - (curpartemp['Oml'] + curpartemp['Omk'] + pf.Omr_fid)
...
params:
  ...
  w0_fld: {value: %s}
  wa_fld: {value: %s}
"""%(pf.nnu, curpartemp['h']*100, 
pf.Omb_fid, OmM, curpartemp['Omk'], pf.Omg_fid,
curpartemp['w0'],curpartemp['wa'])
    
    
info = yaml_load(info_txt_for_plik)
