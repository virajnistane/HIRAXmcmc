...
mpirun python /home/nistanev/mmode/psestimation.py sum_fisher_bias /srv/beegfs/scratch/shares/hirax/secret_hirax_directory/mmode_runs_2023/survey_runs/base_500_600_gaussian_survey_center/hirax/drift_products --power_spectrum_name=psmc_dk_5thresh_fg_1000thresh_1threshold
