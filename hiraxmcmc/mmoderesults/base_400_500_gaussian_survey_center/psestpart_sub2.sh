...
#SBATCH --job-name=psest2_400_500_gaussian_survey_center_dk0fg1
...
mpirun -np 1 python ~/2212_hirax_forecasts/psestimation.py generate_fisher_bias /scratch/s/sievers/nistanev/mmode_runs_2023/survey_runs/base_400_500_gaussian_survey_center/hirax/drift_products --power_spectrum_name=psmc_dk_0thresh_fg_1thresh_1threshold
